...
# export PATH=/Users/Sudhan/Blockchain/HyperLedgerFabric/Hyperledge-fabric/bin:$PATH
# export FABRIC_CFG_PATH="$( echo $(cd ../../ && pwd) )/config/"
...
#     setGlobals 1
#     set -x
#     fcn_call='{"function":"CreateCar","Args":["CAR10","Benz","S-Class","Black","Sudhan"]}'
...
#     infoln "invoke fcn call:${fcn_call}"
#     # peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile $ORDERER_CA -C $CHANNEL_NAME -n ${CC_NAME} --peerAddresses localhost:7051 --tlsRootCertFiles /Users/Sudhan/Blockchain/HyperLedgerFabric/Hyperledge-fabric/test-network/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt --peerAddresses localhost:9051 --tlsRootCertFiles /Users/Sudhan/Blockchain/HyperLedgerFabric/Hyperledge-fabric/test-network/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt --isInit -c ${fcn_call} >&log.txt
...
# chaincodeQueryFabCar 1 QueryCar CAR10
